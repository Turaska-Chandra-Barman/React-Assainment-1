    ...
    <>
      ...
      <IncidentContainer>
        <div className="inecidentMap">
          <h1 className="text-primary font-bold mb-3 text-2xl">
            Where’s the incident?
          </h1>
          <p className="text-[9px] sm:text-sm text-secondary font-normal mb-6">
            Enter a GPS, address. or pin point on the map. Try to be as accurate
            as <br /> possible, or click:Jurisdiction Wide
          </p>
          <div className="relative">
            ...
            <div className="absolute top-2 left-2 max-w-[224] w-full">
              <div className="flex items-center max-w-[224px] w-full rounded-lg mb-1 gap-1  bg-mainChat-bg px-3 py-2 sm:py-4 ">
                ...
                <input
                  type="text"
                  className="w-full bg-inherit  text-secondary focus:outline-none text-xs font-normal"
